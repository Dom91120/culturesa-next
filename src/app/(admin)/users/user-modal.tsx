      ...
      <div className="modal-box" style={{ maxWidth: 640 }}>
        ...
        <div className="form-grid">
          ...
          <div className="field full">
            ...
            >
              Pour des raisons de confidentialité, l'administrateur ne définit pas le mot de passe.
              Un e-mail contenant un lien sécurisé (valable 1 heure) sera envoyé à l'utilisateur,
              qui choisira lui-même son nouveau mot de passe.
            </p>
            <button
              type="button"
