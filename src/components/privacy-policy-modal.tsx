  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={p}>
          <strong>Base légale&nbsp;:</strong> le traitement de vos données personnelles se fonde sur
          votre consentement&nbsp;;
        </p>
        <p style={p}>
          <strong>Finalités&nbsp;:</strong> les données sont collectées afin de pouvoir traiter
          votre demande de réservation, d&apos;en assurer la gestion et de vous contacter en vue de
          bénéficier des services et des informations concernant les activités, évènements et
        ...
        <p style={p}>
          ...
          commune (ludo-médiathèque, maison des arts, finances…), ainsi qu&apos;au Trésor public et
          à la compagnie d&apos;assurance de la commune&nbsp;;
        </p>
        <p style={p}>
        ...
        <p style={p}>
          <strong>Vos droits&nbsp;:</strong> conformément au règlement européen n°2016/679/UE sur la
          protection des données personnelles du 27/04/2016 et à la loi informatique et libertés
          n°78-17 du 06/01/1978, vous disposez d&apos;un droit d&apos;accès, de rectification,
          d&apos;effacement, de limitation du traitement et de portabilité, aux données vous
          concernant. À tout moment, vous pouvez retirer votre consentement et supprimer votre
          compte&nbsp;;
        </p>
        <p style={p}>
          <strong>Exercice de vos droits&nbsp;:</strong> ces droits s&apos;exercent sur simple
          demande adressée par courrier postal à Madame la Maire (Mairie de Châtillon-dpo 1 place de
          la Libération BP 88, 92322 Châtillon Cedex) ou par courrier électronique au délégué à la
