...
/**
 * Pictogramme « Aujourd'hui » : calendrier Lucide + flèche vers la gauche (retour au
 * jour), inspiré du bouton « Aujourd'hui » d'Outlook (Dom 2026-09-06). Même trait que
 * AbsenceGlyph / WaitingListGlyph, `currentColor`.
 */
export function TodayGlyph({ size = 24 }: { size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
